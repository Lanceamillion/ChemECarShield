...
void setup() {
  ...
  // Step 2: Wait for the switch to be on
  ...
  // Step 3: Turn on the relay
  digitalWrite(Relay, HIGH);

  // Step 4: Wait for the sensor to reach the threashold
  while(analogRead(AnalogIn) < 500){
    //Blink the LED green
    digitalWrite(GreenLED, HIGH);
    delay(500);
    digitalWrite(GreenLED, LOW);
...
void loop() {
  // Step 6: Blink the led Blue to show the program is done
